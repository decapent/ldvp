...
$players = @("Sensato_Kuro", "Ziggehgg", "Maxgt", "Personator", "DD_g", "Mickrowatts", "Tinoeud", 
             "Lutoru", "DomDoughty", "Frenchie.D.Senpai", "YugzPower", 
             "BenShowSly", "MaxBlaze64", "Zaltus", "Hizumi", "Moo_Moony", "MaxKetchumz", "Thunderbuzz", 
             "MickeyMentol", "Mannix")
